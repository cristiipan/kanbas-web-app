...
const BootstrapForms2: React.FC = () => {
    return (
...
const BootstrapForms3: React.FC = () => {
    return (
...
const BootstrapForms4: React.FC = () => {
    return (
...
const BootstrapForms5: React.FC = () => {
    return (
...
const BootstrapForms6: React.FC = () => {
    return (
...
const BootstrapForms7: React.FC =() => {
    return (
...
export { BootstrapForms, BootstrapForms2, BootstrapForms3, 
        BootstrapForms4, BootstrapForms5, BootstrapForms6, BootstrapForms7 };